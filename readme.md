...
| 언어 변형 (간체/번체 등) | `탑건매버릭_chi_Traditional.ass` |
...
4. Click the **"자막 추출" (Extract Subtitles)** button. Subtitle files will be saved in the same folder as the original video.
...
|------|------------------|
| Basic | `TopGun_kor.srt` |
| Special tag (SDH, Forced, etc.) | `TopGun_eng_SDH.srt` |
| Language variant | `TopGun_chi_Traditional.ass` |
| Unknown language (und) | `TopGun_undefined.srt` |
